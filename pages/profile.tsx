...
function Profile() {
    ...
    return (
        <div className="h-screen flex justify-center items-center">
            <div className="flex flex-col justify-center items-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-slate-900 text-gray-100">
                <img src={user?.photoURL} className="rounded-full w-52 h-52 object-cover" />
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">{user?.displayName}</h2>
                        {
                            user?.emailVerified
                                ?
                                <p className="px-5 text-xs sm:text-base text-green-600">
                                    Verified
                                </p>
                                :
